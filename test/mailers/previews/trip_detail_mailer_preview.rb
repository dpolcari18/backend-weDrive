class TripDetailMailerPreview < ActionMailer::Preview
    def start_trip_email
        ...
        trip = Trip.new(created_at: "2021-04-11T20:35:52.684Z", real_time: 12349, map_url: "https://www.mapquestapi.com/staticmap/v5/map?start=Dallas&end=Austin&size=170,110@2x&key=jGOGNEMHEi4MNjU7LSSVTTYOoozrHXRW")
